...
module.exports = {
  ...
  resolve: {
    ...
    // modules的设置是让webpack来寻找导入模块的位置，默认从node_modules中寻找，你可以加入src到数组里
    // 或者设置NODE_PATH=src && yarn start
    // 或者项目根目录echo NODE_PATH=src > .env
    ...
    plugins: [
      // 一般情况下，webpack调用babel只编译src下和package.json。如果项目会出现另外一个源文件目录比如src2
      // 需要这样设置new ModuleScopePlugin(paths.appSrc, [paths.appPackageJson, 'src2'])
